...
for i in {1..2}
do
curl 'https://dev.supervise.ly/api/projects/18526/datasets/61128/images/19483077/figures/smartAnnotation' \
  -H 'authority: dev.supervise.ly' \
  ...
  -H 'origin: https://dev.supervise.ly' \
  -H 'pragma: no-cache' \
  -H 'referer: https://dev.supervise.ly/app/images2/?datasetId=61128&imageId=19483077' \
